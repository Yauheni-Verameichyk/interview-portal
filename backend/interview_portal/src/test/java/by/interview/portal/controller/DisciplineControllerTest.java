...
public class DisciplineControllerTest {
    ...
    public void shouldReturnDisciplineWithHeadsById() throws Exception {
        ...
        mvc.perform(get("/discipline/1").contentType(MediaType.APPLICATION_JSON))
    ...
    public void shouldReturnSubItemsList() throws Exception {
        ...
        mvc.perform(get("/discipline/parents/1").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andExpect(jsonPath("$", hasSize(1)))
                .andExpect(jsonPath("$[0].name", is(subItem.getName())));
    }
    ...
    public void shouldSaveDiscipline() throws Exception {
        ...
        mvc.perform(
                post("/discipline").contentType(MediaType.APPLICATION_JSON).content(requestJson))
                .andExpect(status().isOk());
    ...
    public void shouldReturnDisciplinesListForUser() throws Exception {
        given(disciplineFacade.findDisciplinesByUser("user1"))
